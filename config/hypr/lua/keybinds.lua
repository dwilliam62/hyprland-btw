...
bindd("SUPER CTRL", "L", "Lock screen", "exec", "noctalia-shell ipc call sessionMenu lockscreen lock")
bindd("SUPER SHIFT", "Y", "Toggle wallpaper", "exec", "noctalia-shell ipc call wallpaper toggle")
bindd("SUPER", "X", "Open session menu", "exec", "noctalia-shell ipc call sessionMenu toggle")
bindd("SUPER", "C", "Toggle control center", "exec", "noctalia-shell ipc call controlCenter toggle")
bindd("SUPER SHIFT", "C", "Edit config files", "exec", "config-menu")
bindd("SUPER CTRL", "R", "Toggle recorder", "exec", "noctalia-shell ipc call screenRecorder toggle")
